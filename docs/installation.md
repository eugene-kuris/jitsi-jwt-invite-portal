...
The reference deployment was tested on Debian 12 with:
...
## 4. Install the portal and administration utilities
...
## 5. Create the secret configuration files
...
## 6. Install the Prosody role module in an upgrade-safe directory
...
## 7. Disable Jicofo automatic ownership
...
## 8. Disable Jitsi's bare invitation controls
...
## 9. Install and configure the systemd service
...
## 10. Create the first organizer account
...
## 13. Start services in a controlled order
...
## 15. Mandatory browser role test
